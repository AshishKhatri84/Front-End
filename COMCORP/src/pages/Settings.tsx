    ...
    <div className="container py-6 max-w-5xl">
      ...
      <Tabs defaultValue="profile" className="space-y-4">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="profile" className="flex items-center gap-2 text-green-600">
            <User className="h-4 w-4" />
            <span>Profile</span>
          </TabsTrigger>
          <TabsTrigger value="notifications" className="flex items-center gap-2 text-green-600">
            <Bell className="h-4 w-4" />
            <span>Notifications</span>
          </TabsTrigger>
          <TabsTrigger value="security" className="flex items-center gap-2 text-green-600">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col space-y-2 items-center justify-center mb-6">
                ...
                <Button variant="outline" size="sm" className="mt-4 bg-green-500 text-white hover:bg-green-600">
                  Change Avatar
                </Button>
              </div>
            ...
            <CardFooter className="border-t pt-6 flex justify-between">
              <Button variant="outline" className="bg-green-500 text-white hover:bg-green-600">Cancel</Button>
              <Button onClick={saveProfile} className="bg-green-500 text-white hover:bg-green-600">Save Changes</Button>
            </CardFooter>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="notifications">
          <Card>
            ...
            <CardFooter className="border-t pt-6 flex justify-between">
              <Button variant="outline" className="bg-green-500 text-white hover:bg-green-600">Cancel</Button>
              <Button onClick={saveNotifications} className="bg-green-500 text-white hover:bg-green-600">Save Preferences</Button>
            </CardFooter>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="security">
          <Card>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-2">
                    {deviceHistory.map((device, idx) => (
                      <li key={idx}>
                        <div className="text-sm font-semibold">{device.device}</div>
            ...
            <CardFooter className="border-t pt-6 flex justify-between">
              <Button variant="outline" className="bg-green-500 text-white hover:bg-green-600">Cancel</Button>
              <Button onClick={saveSecurity} className="bg-green-500 text-white hover:bg-green-600">Save Security Settings</Button>
            </CardFooter>
          </Card>
        </TabsContent>
      </Tabs>
