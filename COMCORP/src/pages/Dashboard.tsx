  ...
  <Link to={link}>
    <Card className="h-full hover:shadow-md transition-shadow">
      <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
        ...
        <div className={`p-1.5 rounded-full ${variant === "new" ? "bg-light-blue/20 text-light-blue" : "bg-green-500"}`}>
      ...
      <CardContent>
        ...
        {variant === "new" && (
          <span className="inline-flex mt-1 items-center rounded-md bg-light-blue/10 px-2 py-1 text-xs font-medium text-light-blue">
            New activity
          </span>
        )}
      </CardContent>
...
const RecentUpdates = () => {
  ...
  return (
    <div className="space-y-4">
      {updates.map((update) => (
        <div key={update.id} className="flex items-start gap-3 p-3 hover:bg-green-500 rounded-lg transition-colors">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="h-8 w-8 rounded-full bg-light-blue-100 text-light-blue-700 flex items-center justify-center">
                <span>✓</span>
              </div>
            </div>
            <div className="flex items-center justify-between mb-4">
