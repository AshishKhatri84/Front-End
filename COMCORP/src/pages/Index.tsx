...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 to-background">
      <header className="sticky top-0 z-10 w-full backdrop-blur-sm border-b bg-background/80">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <ShieldCheck className="h-6 w-6 text-blue-600" />
            <span className="text-xl font-semibold">COMCORP</span>
          </div>
          <nav className="hidden md:flex items-center gap-6">
            <a href="#features" className="text-sm font-medium hover:text-blue-600">Features</a>
            <a href="#security" className="text-sm font-medium hover:text-blue-600">Security</a>
            <a href="#about" className="text-sm font-medium hover:text-blue-600">About</a>
          </nav>
          <div className="flex items-center gap-2">
            <Button variant="outline" onClick={() => navigate('/login')} className="text-green-600 border-green-600 hover:bg-green-50">
              Sign In
            </Button>
            <Button onClick={() => navigate('/login')} className="bg-green-600 text-white hover:bg-green-700">
              Get Started
            </Button>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Button size="lg" onClick={() => navigate('/login')} className="bg-green-600 text-white hover:bg-green-700">
                Get Started
              </Button>
          ...
          <div className="relative mx-auto aspect-video max-w-xl rounded-xl bg-gradient-to-br from-blue-200 via-blue-100 to-muted/20 shadow-xl">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex flex-col items-center gap-2">
                <ShieldCheck className="h-16 w-16 text-blue-600" />
                <span className="text-xl font-medium">COMCORP Portal</span>
      ...
      <section id="features" className="bg-blue-100 py-16 md:py-20">
      ...
      <section id="security" className="py-16 md:py-20">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button className="mt-8 bg-green-600 text-white hover:bg-green-700">
      ...
      <section id="about" className="bg-blue-100 py-16 md:py-20">
        <div className="container max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">About COMCORP</h2>
          <p className="text-lg text-muted-foreground">
            COMCORP helps organizations maintain secure, compliant communications across distributed teams. Our platform combines cutting-edge encryption technology with a user-friendly interface designed for modern workforces.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="font-semibold">COMCORP</span>
            </div>
          ...
          <div className="mt-8 text-sm text-muted-foreground text-center">
            © {new Date().getFullYear()} COMCORP. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
