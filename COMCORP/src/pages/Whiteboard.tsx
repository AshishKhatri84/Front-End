        ...
        <Card className="flex-1 flex flex-col">
          <CardHeader className="pb-2 flex flex-row items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={saveWhiteboard} className="bg-green-500 text-white hover:bg-green-700">
                <Save className="h-4 w-4 mr-1" /> Save
              </Button>
              <Button variant="outline" size="sm" onClick={downloadWhiteboard} className="bg-green-500 text-white hover:bg-green-700">
                <Download className="h-4 w-4 mr-1" /> Export
              </Button>
              <Button variant="outline" size="sm" onClick={shareWhiteboard} className="bg-green-500 text-white hover:bg-green-700">
              ...
              <div className="flex gap-2 items-center">
                <div className="flex border rounded-md overflow-hidden">
                  {colors.map((color) => (
                    <button
                      key={color}
                      className={`w-6 h-6 ${currentColor === color ? 'ring-2 ring-offset-2 ring-green-500' : ''}`}
