    ...
    <div className="flex flex-col h-screen">
      <div className="border-b p-3 flex justify-between">
        <div className="flex items-center space-x-2">
          <div className="bg-blue-200 p-1.5 rounded-md"> {/* Light blue background */}
            <Hash className="h-5 w-5 text-green-600" /> {/* Green icon */}
          </div>
          <div>
        ...
        <div className="flex items-center space-x-2">
          <Button variant="ghost" size="icon" className="text-green-600"> {/* Green color for button */}
        ...
        <div className="hidden lg:block w-64 border-l p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-center mt-2">
              <Button variant="ghost" size="sm" className="text-xs w-full text-green-600"> {/* Green color for button */}
                View all members
              </Button>
            </div>
          </div>
