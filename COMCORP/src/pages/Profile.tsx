            ...
            <TabsContent value="activity">
              <Card>
                <CardContent className="pt-6 px-6">
                  ...
                  <div className="mt-6">
                    <Button variant="outline" className="w-full bg-green-500 hover:bg-green-600">
                      View All Activity
                    </Button>
                  </div>
                </CardContent>
                ...
                <CardContent className="pt-6 px-6">
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 hover:bg-muted/50 rounded-md transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Hey! Are you free for a quick meeting later today?
                        </p>
                      </div>
                      <Button variant="ghost" size="sm" className="text-xs text-green-600">
                        Reply
                    ...
                    <div className="flex items-start gap-3 p-3 hover:bg-muted/50 rounded-md transition-colors">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between">
                          <p className="text-sm font-medium">Tom Kline</p>
                          <p className="text-xs text-muted-foreground">1 day ago</p>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          I updated the document with new metrics. Check it out!
                        </p>
                      </div>
                      <Button variant="ghost" size="sm" className="text-xs text-green-600">
                        Reply
